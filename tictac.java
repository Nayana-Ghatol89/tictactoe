...
ic1=new ImageIcon("C:\\Users\\admin\\eclipse-workspace\\tictac\\bin\\tictac\\ic1.jpg");  
ic2=new ImageIcon("C:\\Users\\admin\\eclipse-workspace\\tictac\\bin\\tictac\\ic2.jpg");  
ic11=new ImageIcon("C:\\Users\\admin\\eclipse-workspace\\tictac\\bin\\tictac\\ic11.jpg");  
ic22=new ImageIcon("C:\\Users\\admin\\eclipse-workspace\\tictac\\bin\\tictac\\ic22.jpg");  
...
for(i=0;i<=7;i++){  
  ...
  Icon icon3=b[(a[i][3]-1)].getIcon();  
    ...
    JOptionPane.showMessageDialog(tictac.this,"!!!YOU WON!!! click reset");     
         break;  
                   }  
             else if(icon1==ic2){   
             ...
             b[(a[i][3]-1)].setIcon(ic22);   
               JOptionPane.showMessageDialog(tictac.this,"!!!YOU LOSE!!! click reset");  
                break;             
               }  
         }  
    }    
